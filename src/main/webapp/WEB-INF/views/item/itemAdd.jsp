...
<!-- 메뉴바 include -->
	...
	<div id="Detail_Area">
		...
		<form action="enrollItem.ap" method="post" onsubmit="return validate()" enctype="multipart/form-data" autocomplete="off">
		<table id="tableArea" class="table table-bordered">
			<tr>
				<th id="title" colspan="7" style="border-bottom: 3px solid #ACBDB3;" >
					<div id="wrap_btn">
						...
						<div id="btnArea" >
			      			<input type="submit" class="btn" id="enrollItem" value="등록" style="margin-top: 20px;">
			...
			<tr>
				<c:choose>
					...
					<div id="photoArea">
						...
						<div class="pdfbox">
							...
							<input class="upload-name" value="pdf 파일만 가능">
						</div>
						<br><br>
					</div>
				</td>
				...
				<td colspan="3" >
					<input type="text" id="i_name_k" class="form-control" name="i_name_k" class="underline" placeholder="실제 표기와 동일하게 작성" size="30" required="required">
					<input type="hidden" id="i_div" name="i_div" value="${ i_div }">
					<input type="hidden" id="emp_id" name="emp_id" value="${ loginUser.id }">
				</td>
			<tr>
			<tr>
				<td class="index" colspan="1">제품코드</td>
				<td colspan="3" ><input type="text" required="required" class="form-control" name="i_id" placeholder="제품 코드를 입력해주세요" id="i_id"><div id="check"></div></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="3"><input type="text" class="form-control" id="standard" name="standard" placeholder="규격 명확히 작성" required="required"></td>
			</tr>
			<tr>
				<td class="index" colspan="1">성분 / 함량</td>
				<td colspan="3"><input type="text" name="material" id="material" class="form-control" placeholder="성분 및 함량 작성" required="required"></td>
			</tr>
			<c:if test="${ i_div == 2 }">
				<tr>
					<td class="index" colspan="1">급여정보</td>
					<td colspan="3"><input type="text" name="insurance" class="form-control" id="insurance" placeholder="급여정보 입력" required="required"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3"><input type="text" name="atc_code" id="atc_code" class="form-control"  placeholder="ATC_CODE 입력"  required="required"></td>
				</tr>
			</c:if>
			<tr>
				<td class="index" colspan="1">단가</td>
				<td colspan="3"><input type="text" name="price" id="price" class="form-control" placeholder="단위(원) 제외" required="required"></td>
			</tr>
			<tr>
				<td class="index" colspan="1">최초 입고 수량</td>
				<td colspan="3"><input type="text" name="stock" id="stock" class="form-control" placeholder="입고 수량(단위제외)." required="required"></td>
			</tr>
			<tr>
				<td class="index" colspan="1">보관위치</td>
				<td colspan="3"><input type="text" name="location" id="location"  class="form-control" placeholder="보관위치." required="required"></td>
			</tr>
			<tr>
				<td class="index" colspan="1">제조사</td>
				<td colspan="3"><input type="text" name="production" id="production" class="form-control" placeholder="제조사 입력." required="required"></td>
			</tr>
			<tr>
				<td class="index" colspan="1">계약 일자</td>
				<td colspan="3"><input type="date" name="contract_date" id="contract_date" class="form-control" required="required"></td>
			</tr>
			<tr>
				<td class="index" colspan="1">대체물품</td>
				<td  colspan="3" ><input type="text" id="replacement" name="replacement" class="form-control" placeholder="대체제 코드 입력"><div id="replace"></div></td>
			</tr>
			<c:if test="${ i_div == 2 }">
				<tr>
				...
				<tr>
					<td class="memo" colspan="3"><textarea id="add_m" name="add_m" class="form-control" rows="10" cols="60" placeholder="첨가제 기재." ></textarea></td>
					<td class="memo" colspan="4" style="border-left: 1px solid #ACBDB3"><textarea  class="form-control"rows="10" cols="80" id="kpic" name="kpic" placeholder="KPIC 약효분류를 작성하세요"></textarea></td>
				</tr>
			...
			<tr>
				<td class="memo" colspan="3"><textarea rows="10" cols="60"  class="form-control" id="note" name="note"  placeholder="기타 참고할 만한 내용을 작성하세요"></textarea></td>
				<td class="memo" colspan="4" style="border-left: 1px solid #ACBDB3"><textarea  id="perpose" name="perpose"  rows="10" cols="80"  class="form-control" placeholder="용도를 작성하세요."></textarea></td>
			</tr>
		</table>
		</form>
		<br>	
